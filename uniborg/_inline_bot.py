...
[Read More ...](https://da.gd/qGtPI)""",
            ...
            result = builder.article(
                "© @UniBorg",
                text="""@r4v4n4 **( Custom Built By** @Itz_Sj_Dude **)** 
**Verified Account:** ✅
**Official Website:** https://Itzsjdude.in 

**Pithun 3.8.2 (default, Feb 27 2020, 21:41:26)** 
**[GCC 7.4.0]**
**Talethrun 1.11.3**

**Custom Built Fork:** https://github.com/ItzSjDude/MrPerfectBot""",
                buttons=[
                    [custom.Button.url("👤Contact Creator👤", "https://telegram.dog/Itz_Sj_Dude"), custom.Button.url(
                        "Merithub", "https://t.me/Merithub")],
                    [custom.Button.url("👨‍💻Source Code👨‍💻", "https://github.com/ItzSjDude/MrPerfectBot"), custom.Button.url(
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        reply_pop_up_alert += "\n\n Use .unload {} to remove this plugin\n\
            © @Itz_Sj_Dude".format(plugin_name)
        await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
